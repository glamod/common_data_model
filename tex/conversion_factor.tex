...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{conversion}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{description}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{implementation}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{reference}}} \\ \hline\hline \endfirsthead
            \multicolumn{5}{c}{Table \thetable\ conversion\_factor (cont.)} \\
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/conversion_factor.csv}
\end{landscape}
