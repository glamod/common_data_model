...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \hline\hline             \multicolumn{1} { V{1.125000 in}} { \textbf{\seqsplit{variable}}} & 
            \multicolumn{1} { V{1.125000 in}} { \textbf{\seqsplit{variable\_name}}} & 
            \multicolumn{1} { V{1.125000 in}} { \textbf{\seqsplit{code\_value}}} & 
            \multicolumn{1} { V{1.125000 in}} { \textbf{\seqsplit{symbol}}} & 
