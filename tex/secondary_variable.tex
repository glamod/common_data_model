...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            % Initial caption
            \caption{secondary\_variable (NA)}
            \label{tab:DataTableSecondaryvariable}\\
            % Initial column headers
            \hline\hline             \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{secondary\_variable}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{variable\_name}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{code\_value}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{symbol}}} & 
