\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{observation\_value\_significance}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ observation\_value\_significance (cont.)} \\
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/observation_value_significance.csv}
