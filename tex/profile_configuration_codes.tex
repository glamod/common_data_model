...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.100000 in}} { \textbf{\seqsplit{field\_number}}} & 
            ...
            \multicolumn{1} { V{1.100000 in}} { \textbf{\seqsplit{description}}} & 
            \multicolumn{1} { V{1.100000 in}} { \textbf{\seqsplit{start\_date}}} & 
