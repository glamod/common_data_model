...
\multicolumn{1} { > {\centering}V{1.100000 in}} { \textbf{code}} & 
 \multicolumn{1} { > {\centering} V{3.000000 in} } {\textbf{sub\_region}} \\ \hline\hline \endfirsthead
            \multicolumn{4}{c}{Table \thetable\ sub\_region (cont.)} \\
            % column headers on additional pages
            \hline\hline \multicolumn{1} { > {\centering}V{1.100000 in} } { \textbf{value}} & 
\multicolumn{1} { > {\centering}V{1.100000 in} } { \textbf{type}} & 
\multicolumn{1} { > {\centering}V{1.100000 in} } { \textbf{code}} & 
 \multicolumn{1} { > {\centering} V{3.000000 in} } {\textbf{sub\_region}} \\ \hline\hline \endhead
