...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{sub\_region}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{type}}} & 
            \multicolumn{1} { V{1.475000 in}} { \textbf{\seqsplit{code}}} & 
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/sub_region.csv}
\end{landscape}
