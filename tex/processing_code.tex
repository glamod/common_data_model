\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            % Initial caption
            \caption{processing\_code}
            \label{tab:DataTableProcessingcode}\\
            % Initial column headers
            \hline\hline             \multicolumn{1} { V{2.150000 in}} { \textbf{\seqsplit{value}}} & 
            \multicolumn{1} { V{2.150000 in}} { \textbf{\seqsplit{abbreviation}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ processing\_code (cont.)} \\
