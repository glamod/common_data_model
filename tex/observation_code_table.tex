...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \hline\hline             \multicolumn{1} { V{0.900000 in}} { \textbf{\seqsplit{code\_table}}} & 
            \multicolumn{1} { V{0.900000 in}} { \textbf{\seqsplit{code\_table\_scheme}}} & 
            \multicolumn{1} { V{0.900000 in}} { \textbf{\seqsplit{code\_table\_id}}} & 
            \multicolumn{1} { V{0.900000 in}} { \textbf{\seqsplit{code\_table\_name}}} & 
            \multicolumn{1} { V{0.900000 in}} { \textbf{\seqsplit{value}}} & 
