\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{report\_processing\_code}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ report\_processing\_code (cont.)} \\
    ...
    columns/report_processing_code/.style={
            string type, 
            column type= V{1.900000 in}, 
            string replace*={_}{\_}
        },
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/report_processing_code.csv}
