\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            % Initial caption
            \caption{instrument\_exposure\_quality (WIGOS Code Table 5-15)}
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{instrument\_exposure\_quality}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ instrument\_exposure\_quality (cont.)} \\
    ...
    columns/instrument_exposure_quality/.style={
            string type, 
            column type= V{1.900000 in}, 
            string replace*={_}{\_}
        },
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/instrument_exposure_quality.csv}
