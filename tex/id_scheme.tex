\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{id\_scheme}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ id\_scheme (cont.)} \\
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/id_scheme.csv}
