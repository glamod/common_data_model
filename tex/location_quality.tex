\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{location\_quality}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ location\_quality (cont.)} \\
    ...
    columns/location_quality/.style={
            string type, 
            column type= V{1.900000 in}, 
            string replace*={_}{\_}
        },
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/location_quality.csv}
