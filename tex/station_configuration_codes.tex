...
\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.180000 in}} { \textbf{\seqsplit{abbreviation}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{6}{c}{Table \thetable\ station\_configuration\_codes (cont.)} \\
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/station_configuration_codes.csv}
\end{landscape}
