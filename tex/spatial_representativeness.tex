\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            % Initial caption
            \caption{spatial\_representativeness (WIGOS 1-05)}
            \label{tab:DataTableSpatialrepresentativeness}\\
            % Initial column headers
            \hline\hline             \multicolumn{1} { V{1.800000 in}} { \textbf{\seqsplit{spatial\_representativeness}}} & 
            \multicolumn{1} { V{5.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{2}{c}{Table \thetable\ spatial\_representativeness (cont.)} \\
            % column headers on additional pages
            \hline\hline             \multicolumn{1} {V{1.800000 in} } { \textbf{\seqsplit{spatial\_representativeness}}} & 
            \multicolumn{1} { V{5.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endhead
    ...
    columns/spatial_representativeness/.style={
            string type, 
            column type= V{1.800000 in}, 
            string replace*={_}{\_}
        },
    columns/description/.style={
            string type, 
            string replace*={_}{\_},
            column type = V{5.000000 in}
        }
