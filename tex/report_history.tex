\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            % Initial caption
            \caption{report\_history}
            \label{tab:DataTableReporthistory}\\
            % Initial column headers
            \hline\hline             \multicolumn{1} { V{1.433333 in}} { \textbf{\seqsplit{element\_number}}} & 
            \multicolumn{1} { V{1.433333 in}} { \textbf{\seqsplit{element\_name}}} & 
            \multicolumn{1} { V{1.433333 in}} { \textbf{\seqsplit{type}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{Description}}} \\ \hline\hline \endfirsthead
            \multicolumn{4}{c}{Table \thetable\ report\_history (cont.)} \\
