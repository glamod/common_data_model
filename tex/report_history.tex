\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \hline\hline             \multicolumn{1} { V{1.266667 in}} { \textbf{\seqsplit{element\_number}}} & 
            \multicolumn{1} { V{1.266667 in}} { \textbf{\seqsplit{element\_name}}} & 
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/report_history.csv}
