\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.900000 in}} { \textbf{\seqsplit{platform\_type}}} & 
            \multicolumn{1} { V{3.000000 in} } {\textbf{\seqsplit{description}}} \\ \hline\hline \endfirsthead
            \multicolumn{3}{c}{Table \thetable\ platform\_type (cont.)} \\
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/platform_type.csv}
