\pgfplotstabletypeset[
    ...
    every first row/.append style={
        before row={%
            ...
            \multicolumn{1} { V{1.266667 in}} { \textbf{\seqsplit{observing\_frequency}}} & 
            \multicolumn{1} { V{1.266667 in}} { \textbf{\seqsplit{abbreviatione}}} & 
    ...
    ]{/Users/dyb/GitHub/common_data_model/tables/observing_frequency.csv}
