...
echo '<TR><TD COLSPAN="'$ncols'" ALIGN="left"># URL: https://github.com/glamod/common_data_model/blob/master/tables/'$tablename'.dat</TD></TR>' >> ${tablename}.gv
  ...
  /^[^#]/ && /^[^element_name]/ { \
      ...
      for(i=2;i<=NF;i++){ \
        if( i == extcolumn && length($i) > 1 ){ \
          printf "<TD HREF=\"https://github.com/glamod/common_data_model/blob/master/tables/%s.dat\">",$i \
